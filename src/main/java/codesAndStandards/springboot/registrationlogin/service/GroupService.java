...
public class GroupService {
    ...
    @Transactional
    public List<Long> getGroupIdsByDocumentId(int documentId) {
        try {
     ...
     */
    @Transactional(readOnly = true)
    public List<GroupListDTO> getGroupsByDocumentId(int documentId) {
     ...
     */
    @Transactional(readOnly = true)
    public AccessCheckDTO checkUserAccessToDocument(Long userId, int documentId) {
     ...
     */
    @Transactional
    public void addDocumentToGroup(Long groupId, int documentId) {
     ...
     */
    @Transactional
    public void removeDocumentFromGroup(Long groupId, int documentId) {
    ...
    public void addDocumentsToGroup(Group group, List<Long> documentIds, User currentUser) {
        ...
        List<Integer> docIdsAsInt = documentIds.stream()
                .map(Long::intValue)
                .collect(Collectors.toList());
