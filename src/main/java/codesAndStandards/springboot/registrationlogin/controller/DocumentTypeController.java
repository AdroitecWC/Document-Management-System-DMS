...
public class DocumentTypeController {
     ...
     */
    @GetMapping
    @PreAuthorize("hasRole('superadmin') or hasAuthority('DOCUMENT_TYPE_VIEW')")
     ...
     */
    @PostMapping
    @PreAuthorize("hasRole('superadmin') or hasAuthority('METADATA_UPDATE')") // Using METADATA_UPDATE for managing structure
