...
public class TagController {
    ...
    @PostMapping
    @PreAuthorize("hasRole('superadmin') or hasAuthority('TAG_CREATE')")
    ...
    @PutMapping("/{id}")
    @PreAuthorize("hasRole('superadmin') or hasAuthority('TAG_UPDATE')")
    ...
    @DeleteMapping("/{id}")
    @PreAuthorize("hasRole('superadmin') or hasAuthority('TAG_DELETE')")
