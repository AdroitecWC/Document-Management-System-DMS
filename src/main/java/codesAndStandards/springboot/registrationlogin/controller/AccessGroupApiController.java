...
public class AccessGroupApiController {
     ...
     */
    @PostMapping
    @PreAuthorize("hasRole('superadmin') or hasAuthority('GROUP_CREATE')")
     ...
     */
    @PutMapping("/{id}")
    @PreAuthorize("hasRole('superadmin') or hasAuthority('GROUP_UPDATE')")
     ...
     */
    @DeleteMapping("/{id}")
    @PreAuthorize("hasRole('superadmin') or hasAuthority('GROUP_DELETE')")
